# Generated by Django 5.1.1 on 2025-01-17 18:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.CharField(choices=[('NN', 'No registra'), ('ADMIN', 'Administrador'), ('SUBDIRECTOR', 'Subdirector'), ('RECEPTION', 'Recepcionista'), ('TREASURY', 'Tesorería'), ('IT_MANAGER', 'Coordinador de Sistemas'), ('MAINTENANCE', 'Mantenimiento'), ('GOLF_PRO', 'Profesional de Golf'), ('TENNIS_PRO', 'Profesional de Tenis'), ('LIFEGUARD', 'Salvavidas'), ('CHEF', 'Chef'), ('WAITER', 'Mesero'), ('HOUSEKEEPING', 'Servicio de Limpieza'), ('EVENT_MANAGER', 'Gerente de Eventos'), ('SECURITY', 'Seguridad'), ('GARDENER', 'Jardinero'), ('ACCOUNTANT', 'Contador'), ('HR', 'Recursos Humanos'), ('MEMBER_RELATIONS', 'Relaciones con Miembros')], default='NN', max_length=255, verbose_name='Cargo')),
